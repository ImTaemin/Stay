...
<body>
	<div class="find-form">
		...
		<form>
			...
			<input type="text" id="inputName" name="inputName" placeholder="이름을 입력하세요" required="required" autofocus="autofocus">
			
			<br>
			
			<label for="inputHp">연락처</label>
			<input type="tel" class="phoneNumber" id="inputHp" name="inputHp" placeholder="핸드폰 번호를 입력하세요" required="required"
			autofocus="autofocus">
		...
		<div class="modal">
			<div id="background_modal" class="background_modal">
				<div class="modal_contents">
					...
					<br>
					<button type="submit" id="pwSearch_btn" class="findPw-btn">비밀번호 찾기</button>
				</div>
			</div>
		</div>
	</form>
