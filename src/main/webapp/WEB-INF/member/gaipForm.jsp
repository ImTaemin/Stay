...
<body>
 <div class="gaip-form">
  ...
  <form action="insert" method="post">
    ...
    <label for="pass_check">비밀번호 확인&nbsp;<span class="required">*</span></label>
  	<div class="gaip-input-check">
  	...
  	<label for="hp">연락처&nbsp;<span class="required">*</span></label>
  	  <input type="tel" class="phoneNumber" id="hp" name="hp" placeholder="핸드폰 번호를 입력하세요" required="required">
  	<label for="email">이메일&nbsp;<span class="required">*</span></label>
  	  <input type="email" id="email" name="e_mail" placeholder="이메일을 입력하세요" required="required">
