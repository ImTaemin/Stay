 ...
 <div class="gaip-form">
  ...
  <form action="gaipform" method="post">
    ...
    <div class="gaip-input">
      <input type="text" id="id" minlength="5" maxlength="12" disabled="disabled">
      <button type="button" id="idcheck" class="input-btn">아이디 입력</button>
    </div>
    <label for="pass">비밀번호</label>
      <input type="password" id="pass" minlength="8" maxlength="16" placeholder="비밀번호를 입력하세요(8~16자 영문·특수문자 조합)" required="required">
    <label for="pass_check">비밀번호 확인</label>
      <input type="password" id="pass_check" placeholder="비밀번호 확인" required="required">
  	<label for="name">이름</label>
  	  <input type="text" placeholder="이름을 입력하세요" required="required">
  	<label for="brith">생일</label>
  	  <input type="date">
  	<label for="addr">주소</label>
  	<div class="gaip-input">
  	  <input type="text" id="addr" name="addr" disabled="disabled">
  	  <button type="button" name="addr" class="input-btn">주소 찾기</button>
  	</div>
  	  <input type="text" name="addr" placeholder="상세주소를 입력하세요">
  	<label for="hp">핸드폰 번호</label>
  	  <input type="tel" id="hp" placeholder="'-'를 제외한 핸드폰 번호를 입력하세요" required="required">
